...
let translate (globals, functions) =
  ...
  let edge_t     = L.struct_type context [|mutex_t; double_t; node_pointer; node_pointer; i8_t|] in
  ...
  let _ = L.struct_set_body node_t [|mutex_t; i32_t; L.pointer_type i8_t; i8_t; edgelist_pointer; node_pointer; i32_t; i32_t; i8_t|] false in
